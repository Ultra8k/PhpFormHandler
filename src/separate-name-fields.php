      ...
      <form id="contactus" class="mt-4" action="<?php echo $form->GetFormAction(); ?>" method="post" accept-charset="UTF-8">
        ...
        <div class="flex flex-wrap">
          <div class="w-full md:w-1/2 px-4">
            <div class="mb-4">
              <label for="name" class="block mb-2 text-sm text-gray-50">Your First Name</label>

              <!-- name field -->
              <?php echo $form->FirstNameField(); ?>
            </div>
            <div class="mb-4">
              <label for="name" class="block mb-2 text-sm text-gray-50">Your Last Name</label>

              <!-- name field -->
              <?php echo $form->LastNameField(); ?>
            </div>
            <div class="mb-4">
