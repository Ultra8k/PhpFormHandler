...
<body>
  <div id="contact-cta" class="container px-4 py-6 flex align-center justify-center">
    <div class="w-full">
      ...
      <form id="contactus" class="mt-4" action="<?php echo $form->handler->GetFormAction(); ?>" method="post" accept-charset="UTF-8">
        <?php echo $form->handler->SpamField(); ?>
        <div class="flex flex-wrap">
          ...
          <div class="w-full md:w-1/2 px-4">
            <div class="mb-4">
              ...
              <!-- message field -->
              <?php echo $form->handler->MessageField(); ?>
            </div>
          </div>
